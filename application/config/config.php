...
$config['css']          =   'static/css/';
$config['images']          =   'static/images/';
$config['js']          =   'static/js/';
$config['nav']          =   'http://localhost/evoting/index.php';
...
|
*/
$config['encryption_key'] = 'whgNEwoh6CvkcPUCc0EbH8yzfBsuBbi6';
...
$config['csrf_token_name'] = 'csrf_token_evoting';
