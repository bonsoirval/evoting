      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <?php form_open($action="", $attributes=array('method'=>"POST"));?>
              <div class="row mb-3">
                <label for="inputText" class="col-sm-2 col-form-label">Name</label>
                <div class="col-sm-10">
                  <?php form_error('party', '<div class="error">', '</div>'); ?>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <?php  form_error('abbreviation', '<div class="error">', '</div>'); ?>
                </div>
              </div>
              <div class="row mb-3">
                <label for="inputEmail" class="col-sm-2 col-form-label">Slogan</label>
                <div class="col-sm-10">
                  <?php  form_error('slogan', '<div class="error">', '</div>'); ?>
                </div>
              </div>
              <div class="row mb-3">
                <label for="inputEmail" class="col-sm-2 col-form-label">Ideology</label>
                <div class="col-sm-10">
                  <?php form_error('ideologoy', 'div class="errro">', '</div>'); ?>
                </div>
              </div>
              <div class="row mb-3">
